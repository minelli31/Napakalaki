...
public class GameTester {
    ...
    private void manageMakeTreasureVisible(Player aPlayer) {
        ...
        do {    // Se hacen tesoros visibles hasta que se vuelve al menú anterior
            howMany = showTreasures("Elige tesoros para intentar hacerlos visibles",
                                    aPlayer.getHiddenTreasures(),
                                    true);
            option = getTreasure(howMany);
    ...
    private Command getCommandAfterFighting() {
        Command commands[] = {
            Command.ShowMonster, Command.ShowVisibleTreasure, Command.ShowHiddenTreasure,
    ...
    private Command getCommandBeforeFighting() {
        Command commands[] = { Command.ShowMonster, Command.ShowVisibleTreasure, Command.ShowHiddenTreasure,
